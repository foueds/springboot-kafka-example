package com.foued.springbootkafkaexample.controller;

import com.foued.springbootkafkaexample.PracticalAdvice;
...
public class HelloKafkaController {
    ...
    public String hello() throws Exception {
        ...
        IntStream.range(0, messagesPerRequest) // equivalent of for (int i = 0; i < messagesPerRequest ; i++)
              .forEach(i -> this.template.send(topicName, String.valueOf(i),
                    "A Practical Advice " + i)
              );
